...
export function ImpactSection() {
  ...
  return (
    <section id="impact" className="py-16 md:py-32 px-6 md:px-20 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="order-2 md:order-1 relative h-[400px] md:h-[600px] w-full group">
          <div className="absolute inset-0 border border-primary/20 translate-x-4 translate-y-4 md:translate-x-6 md:translate-y-6 -z-10 group-hover:translate-x-6 group-hover:translate-y-6 md:group-hover:translate-x-8 md:group-hover:translate-y-8 transition-transform duration-500" />
        ...
        <div className="order-1 md:order-2 space-y-8 md:space-y-12">
          ...
          <div className="space-y-8 md:space-y-10">
            {impactPoints.map((item, idx) => (
              <div key={idx} className="relative pl-8 md:pl-10 border-l border-primary/20 hover:border-primary transition-colors py-2">
          ...
          <blockquote className="font-accent text-xl md:text-2xl text-foreground/40 italic border-l-4 border-accent pl-6 md:pl-8 py-4">
